    ...
    <div>
      <section className="py-16 md:py-20 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <h1 className="text-3xl md:text-4xl font-heading font-extrabold text-gray-950 tracking-tight">Privacy Policy</h1>
          <p className="mt-3 text-sm text-gray-400">Last updated: {privacy.lastUpdated}</p>
        </div>
      </section>
      <SectionDivider />
      <section className="py-16 md:py-20 px-6">
